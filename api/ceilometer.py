...
log.info("Ceilometer API Validation - Begin")
...
if token is not None:
    headers = {'Content-Type' : 'application/json',
               'X-Auth-Token' : token}
    endpoint = keystone_client.get_public_endpoint('ceilometer')
    ...
    log.info('Auth token null. Skipping Ceilometer calls')
log.info("Ceilometer API Validation - End")